...
export default function BusinessPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        setStatus("✅ Your inquiry has been sent to our Sales team!");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-950 flex items-center justify-center px-6">
      <div className="glass-morphism rounded-2xl p-10 w-full max-w-2xl">
        <h1 className="text-3xl font-bold text-white text-center mb-6">Business Inquiries</h1>
        <p className="text-slate-300 text-center mb-8">
          For partnerships, enterprise solutions, or business inquiries, please fill the form below. Our Sales team will get back to you shortly.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-semibold hover:shadow-lg hover:shadow-blue-500/25 transition-all"
          >
            Send Inquiry
          </button>
        </form>
